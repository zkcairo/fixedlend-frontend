...
const SafetyBox = ({ valueamount, valueyield, minimal_duration, maximal_duration, type, takeormake = false, set_isvalid }: Props) => {
    ...
    const warnings = {
        ...
        longLendDuration: type === "lend" && maximal_duration > 10 * 24,
        longBorrowDuration: type === "borrow" && minimal_duration > 10 * 24,
    ...
    return (
        <div className="flex flex-col gap-2">
            {warnings.lowYield && <Warning id="lowYield" text="Your lend yield is below 5% APR. Are you sure? Better rates may be available." />}
            ...
            {warnings.longLendDuration && <Warning id="longLendDuration" text="Maximal duration is over 10 days. You cannot withdraw your assets during this period. Acknowledge this lock-up." />}
            {warnings.longBorrowDuration && <Warning id="longBorrowDuration" text="Minimal duration is over 10 days. You CANNOT repay early to retrieve your collateral. Acknowledge this commitment." />}
